...
const getAllRw = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const rw = yield (0, knex_1.default)("dusun")
        .select("rw.rw_id", "rw.no_rw", "residents.nama as ketua_rw", "dusun.nama_dusun ", "rw.jumlah_keluarga", "rw.jumlah_warga", "rw.create_at")
        .innerJoin("rw", "rw.dusun_id", "dusun.dusun_id")
        .innerJoin("residents", "rw.ketua_rw_nik", "residents.nik")
        .then((result) => {
        return result.map((rw) => {
            return Object.assign(Object.assign({}, rw), { create_at: (0, moment_1.default)(rw.create_at).format("DD MMMM YYYY") });
        });
    });
