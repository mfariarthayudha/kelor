...
const documentController = __importStar(require("../../controllers/web/documents-controller"));
const router = express_1.default.Router();
router.get("/", documentController.getDocumentAll);
router.get("/result/:documentResultId", documentController.viewSurat);
router.get("/surat-keterangan-domisili-usaha/create", documentController.createSuratKeteranganDomisiliUsaha);
// router.get("/:surat/create", documentController.createSurat);
router.get("/surat-pernyataan-SKU/create", documentController.createSuratPernyataanSKU);
